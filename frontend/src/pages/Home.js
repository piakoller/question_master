    ...
    return (
        <div className='page'>
            <div className='headline'>
                ...
                <p>This user study aims to improve educational materials related to theranostic and nuclear medicine.  <br/><strong>**Please note:** Answers are generated by a large language model and may not be entirely accurate.</strong></p>
            </div>
            <div className='text'>
                <h2>Why Your Input Matters:</h2>
                <p>We are developing resources to educate people about the exciting field of theranostic and nuclear medicine. Your participation will help us ensure the information is clear, accurate, and easy to understand.</p>
