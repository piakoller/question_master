        ...
        <div className='page'>
            ...
            <div className='text'>
                ...
                <ul>
                    ...
                    <br /><strong>Keep in mind the answers are generated by AI models and may not be entirely accurate.</strong> 
                        <br />
                        <ul>
                            <li>Please select the answer you believe is more informative and helpful for someone learning about this field.</li>
                            <li>If you believe none of the answers are correct or you can't decide, choose the button <strong>'Neither'</strong>.</li>
                            <li>The order of the questions and the model is randomly selected. You may see a question more than once. It is also possible that answers are similar or the same.</li>
                            <li>Don't be unsettled by answers like "This question cannot be answered from the given context". Some of the AI models were provided with additional information to their pre-trained knowledge. However, some of them weren't able to answer questions correctly.</li>
                        </ul>
                        </li>
