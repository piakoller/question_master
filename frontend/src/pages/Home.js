            ...
            <div className='text'>
                ...
                <ul>
                    <li><strong>The Task:</strong><br />You will be presented with 10 multiple-choice questions related to theranostics, nuclear medicine, and ITM. Each question will offer two answer options.
                        ...
                        <br />The order of the questions and the answer is randomly selected. You may see a question more than once. It is also possible that answers are similar or the same.</li>
